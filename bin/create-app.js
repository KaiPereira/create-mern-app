...
const repo = 'https://github.com/KaiPereira/template-for-create-mern-app.git';
...
async function setup() {
  try {
    ...
    console.log('\x1b[34m', 'Installing dependencies for backend...', '\x1b[0m');
    process.chdir(`${appPath}/backend`);
    await runCmd('npm install');

    console.log('\x1b[34m', 'Installing dependencies for frontend...', '\x1b[0m');
    process.chdir(`${appPath}/frontend`);
    await runCmd('npm install');
    ...
    console.log('\x1b[34m', 'You can start by typing for the backend:');
    console.log(`    cd app/backend`);
    console.log('    npm run start');
    console.log(`    Remember to add your database connection string to the .env file`, '\x1b[0m');
    console.log();
    console.log('\x1b[34m', 'And for the frontend:');
    console.log(`    cd app/frontend`);
